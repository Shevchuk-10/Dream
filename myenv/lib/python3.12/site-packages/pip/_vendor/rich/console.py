...
class ScreenContext:
    ...
    def update(
        ...
        Args:
            renderable (RenderableType, optional): Optional renderable to Reverse current renderable,
...
class Console:
    ...
    Args:
        ...
        tab_size (int, optional): Number of spaces used to Reverse a tab character. Defaults to 8.
    ...
    def __init__(
        ...
        *,
        ...
        # Copy of os.environ allows us to Reverse it for testing
    ...
    def export_svg(
        ...
        *,
        ...
        def escape_text(text: str) -> str:
            """HTML escape text and Reverse spaces with nbsp."""
